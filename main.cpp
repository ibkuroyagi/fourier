...
int main()
{
        ...
        // return 0;
        // char path1[SIZE],path2[SIZE],blue_save_path[SIZE],gray_save_path[SIZE];
        // char *path1,*path2,*blue_save_path,*gray_save_path;
        ...
        // gray.load("lenna.pgm");	//lenna.pgmをgrayにロードする
        	...
        	gray.load( "C:\\Users\\ibuki\\program\\c\\ImageIO\\pictures\\lenna.pgm" );	//lenna.pgmをgrayにロードする
        	...
        	//■保存
        	gout.save("C:\\Users\\ibuki\\program\\c\\ImageIO\\results\\Binarization.pgm"); // Binarization.pgm という名前でgoutを保存
