...
int main(void)
{
        ...
        // }
        //■出力配列確保
        gout_mean.create(gray.W, gray.H); // goutに img.W(画像imgの横幅) x img.H(画像imgの縦幅) の大きさの画素配列を用意する
        ...
        //         printf("\n");
        // }
        char gout_mean_path[] = "C:\\Users\\ibuki\\program\\c\\ImageIO\\results\\lenna_mean.pgm";
